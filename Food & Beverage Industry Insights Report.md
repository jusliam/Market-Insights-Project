...
<br>
#### **Database Schema**
![Alt text](market_insights_schema.png)
...
![Alt text](<Customer Preferences Dashboard.png>)

![Alt text](<Demographic Dashboard.png>)

![Alt text](<Purchase Behavior Dashboard.png>)
